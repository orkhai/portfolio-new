...
const ThemeToggle = () => {
  ...
  return (
    <button
      className="relative mr-10 inline-block h-7.5 w-6.25 cursor-pointer text-center align-middle"
      onClick={() => setTheme(theme === "dark" ? "light" : "dark")}
    >
      {theme === "dark" ? (
        <span className="absolute top-1/2 left-1/2 -mt-3 -ml-3 h-6 w-6 leading-0">
          <svg
