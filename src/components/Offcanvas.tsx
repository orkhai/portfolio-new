...
const Offcanvas = () => {
  ...
  return (
    <div
      className={`dark:border-header-border-dark dark:bg-black-canvas fixed top-0 right-0 z-9999 h-full w-full transform overflow-x-hidden overflow-y-scroll bg-white p-12.5 transition-transform duration-300 ease-out md:w-112.5 dark:border ${isMenuOpen ? "translate-x-0" : "translate-x-[calc(100%+80px)]"}`}
    >
      <div className="tp-offcanvas-shape">
        {/* <img
          className="tp-offcanvas-shape-2"
          src="assets/img/offcanvas/bg-shape-3.html"
          alt=""
        /> */}
      </div>
          ...
          <div className="tp-offcanvas-logo-2">
            {/* <a href="#">
              <img
                ...
                src="assets/img/logo/logo.html"
                alt=""
              />
              <img
                className="logo-black"
                src="assets/img/logo/logo-black.html"
                alt=""
              />
            </a> */}
          </div>
            ...
            <div className="row gx-2">
              <div className="col-md-3 col-3">
                <div className="tp-offcanvas-gallery-img fix">
                  <a href="#">
                    {/* <img src="assets/img/offcanvas/offcanvas-1.html" alt="" /> */}
                  </a>
                </div>
              </div>
              <div className="col-md-3 col-3">
                <div className="tp-offcanvas-gallery-img fix">
                  <a href="#">
                    {/* <img src="assets/img/offcanvas/offcanvas-2.html" alt="" /> */}
                  </a>
                </div>
              </div>
              <div className="col-md-3 col-3">
