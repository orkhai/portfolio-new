      ...
      <div className="flex flex-col gap-11 2xl:flex-row">
        <div className="border-border relative flex aspect-4/3 w-full items-center justify-center rounded-lg border 2xl:basis-[70%]">
          <div className="absolute h-full w-full overflow-hidden opacity-40 transition-opacity duration-1000">
            <Image
              alt="Danso project image background"
              width={100}
              height={100}
          ...
          <ProjectCarousel
            ...
            link="https://www.dansogroupng.com"
          />
        </div>
        <div className="mt-8 w-full space-y-10 2xl:basis-[30%]">
          <div>
            <h1 className="text-3xl font-bold">Danso Group</h1>
            <p className="text-lg text-gray-500">
              A corporate website built for an oil and gas company with
              diversified business interests, designed to clearly present the
              company&#39;s operations, expertise, and service offerings across
              multiple sectors.
            </p>
          ...
          <div>
            ...
            <p className="mt-4 text-lg text-balance">
              The site serves as an authoritative digital presence for
              stakeholders, partners, and prospective clients.
            </p>
          </div>
          ...
          <a
            ...
            href="https://www.dansogroupng.com"
            target="_blank"
          >
