const Footer = () => {
  return (
    <footer className="bg-background">
      <div className="border-border text-foreground border-t px-5 pt-8 pb-4 sm:px-20 xl:px-52">
      ...
      <div className="text-foreground px-5 pb-6 sm:px-20 xl:px-52">
        <div className="mx-auto flex items-center justify-between">
          <p className="text-xs sm:text-sm">
            © {new Date().getFullYear()} Orkhai.
            <br className="block sm:hidden" /> All rights are reserved.
          </p>
