      ...
      <div className="flex flex-col gap-11 2xl:flex-row">
        <div className="border-border relative flex aspect-4/3 w-full items-center justify-center rounded-lg border 2xl:basis-[70%]">
          <div className="absolute h-full w-full overflow-hidden opacity-40 transition-opacity duration-1000">
            <Image
              alt="TLP project image background"
              width={100}
              height={100}
          ...
          <ProjectCarousel
            ...
            link="https://www.thinklikeapianist.com"
          />
        </div>
        <div className="mt-8 w-full space-y-10 2xl:basis-[30%]">
          <div>
            <h1 className="text-3xl font-bold">Think Like a Pianist</h1>
            <p className="text-lg text-gray-500">
              A full-stack and mobile subscription-based e-learning platform
              designed to help users learn and improve their piano skills
          ...
          <div>
            ...
            <p className="mt-4 text-lg text-balance">
              The platform delivers secure, high-quality video content globally,
              ensuring only subscribed users can access lessons based on their
              plan, while protecting creators’ intellectual property. The
              application is actively used by 6,600+ users across 140+
              countries, demonstrating real-world scalability and production
              readiness.
            </p>
          </div>
          ...
          <a
            ...
            href="https://www.thinklikeapianist.com"
            target="_blank"
          >
          ...
          <a
            ...
            href="https://play.google.com/store/apps/details?id=com.delect.tlpMobile"
            target="_blank"
          >
